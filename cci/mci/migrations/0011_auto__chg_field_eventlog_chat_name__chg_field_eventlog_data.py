...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventLog.chat_name'
        db.alter_column('mci_eventlog', 'chat_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'EventLog.data'
        db.alter_column('mci_eventlog', 'data', self.gf('django.db.models.fields.TextField')())
    def backwards(self, orm):

        # Changing field 'EventLog.chat_name'
        db.alter_column('mci_eventlog', 'chat_name', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'EventLog.data'
        db.alter_column('mci_eventlog', 'data', self.gf('django.db.models.fields.TextField')(null=True))
    models = {
        'mci.completedtask': {
        ...
        'mci.eventlog': {
            ...
            'chat_name': ('django.db.models.fields.TextField', [], {'default': "''"}),
