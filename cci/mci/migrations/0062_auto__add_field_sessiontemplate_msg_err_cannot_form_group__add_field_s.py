...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionTemplate.msg_err_cannot_form_group'
        db.add_column('mci_sessiontemplate', 'msg_err_cannot_form_group',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Session.msg_err_cannot_form_group'
        db.add_column('mci_session', 'msg_err_cannot_form_group',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionTemplate.msg_err_cannot_form_group'
        db.delete_column('mci_sessiontemplate', 'msg_err_cannot_form_group')

        # Deleting field 'Session.msg_err_cannot_form_group'
        db.delete_column('mci_session', 'msg_err_cannot_form_group')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)'}),
