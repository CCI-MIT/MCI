...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConcentrationCard'
        db.create_table('mci_concentrationcard', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('imageset', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('mci', ['ConcentrationCard'])

    def backwards(self, orm):
        # Deleting model 'ConcentrationCard'
        db.delete_table('mci_concentrationcard')
