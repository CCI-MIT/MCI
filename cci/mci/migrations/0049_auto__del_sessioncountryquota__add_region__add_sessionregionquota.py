...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Region'
        db.create_table('mci_region', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('mci', ['Region'])

        # Adding M2M table for field countries on 'Region'
        db.create_table('mci_region_countries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('region', models.ForeignKey(orm['mci.region'], null=False)),
            ('subjectcountry', models.ForeignKey(orm['mci.subjectcountry'], null=False))
        ))
        db.create_unique('mci_region_countries', ['region_id', 'subjectcountry_id'])

        # Adding model 'SessionRegionQuota'
        db.create_table('mci_sessionregionquota', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sessionbuilder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SessionBuilder'])),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.Region'])),
            ('subjects', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('mci', ['SessionRegionQuota'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('mci_region')

        # Removing M2M table for field countries on 'Region'
        db.delete_table('mci_region_countries')

        # Deleting model 'SessionRegionQuota'
        db.delete_table('mci_sessionregionquota')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 0, 0)'}),
            ...
            'waiting_for_updated_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 10, 0, 0)'})
        },
        'mci.subject': {
