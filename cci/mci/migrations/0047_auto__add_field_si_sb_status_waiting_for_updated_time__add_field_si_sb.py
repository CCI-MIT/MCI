...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SI_SB_Status.waiting_for_updated_time'
        db.add_column('mci_si_sb_status', 'waiting_for_updated_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 9, 0, 0)),
                      keep_default=False)

        # Adding field 'SI_SB_Status.waiting_for'
        db.add_column('mci_si_sb_status', 'waiting_for',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'SI_SB_Status.last_waiting_room_checkin'
        db.add_column('mci_si_sb_status', 'last_waiting_room_checkin',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 9, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SI_SB_Status.waiting_for_updated_time'
        db.delete_column('mci_si_sb_status', 'waiting_for_updated_time')

        # Deleting field 'SI_SB_Status.waiting_for'
        db.delete_column('mci_si_sb_status', 'waiting_for')

        # Deleting field 'SI_SB_Status.last_waiting_room_checkin'
        db.delete_column('mci_si_sb_status', 'last_waiting_room_checkin')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 9, 0, 0)'}),
            ...
            'waiting_for_updated_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 9, 0, 0)'})
        },
        'mci.subject': {
