...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompletedTask.num_rounds'
        db.add_column('mci_completedtask', 'num_rounds',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompletedTask.num_rounds'
        db.delete_column('mci_completedtask', 'num_rounds')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 0, 0)'}),
