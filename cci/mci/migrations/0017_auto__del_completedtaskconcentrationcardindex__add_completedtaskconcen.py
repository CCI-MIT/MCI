...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CompletedTaskConcentrationCardIndex'
        db.delete_table('mci_completedtaskconcentrationcardindex')
        ...
        # Deleting field 'ConcentrationCard.imageset'
        db.delete_column('mci_concentrationcard', 'imageset')

        # Adding field 'ConcentrationCard.name'
        db.add_column('mci_concentrationcard', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subject.opentok_token'
        db.add_column('mci_subject', 'opentok_token',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding model 'CompletedTaskConcentrationCardIndex'
        db.create_table('mci_completedtaskconcentrationcardindex', (
            ('index', self.gf('django.db.models.fields.IntegerField')()),
            ('completed_task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.CompletedTask'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concentration_card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.ConcentrationCard'])),
        ))
        db.send_create_signal('mci', ['CompletedTaskConcentrationCardIndex'])
        ...
        # Adding field 'ConcentrationCard.imageset'
        db.add_column('mci_concentrationcard', 'imageset',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=200),
                      keep_default=False)

        # Deleting field 'ConcentrationCard.name'
        db.delete_column('mci_concentrationcard', 'name')

        # Deleting field 'Subject.opentok_token'
        db.delete_column('mci_subject', 'opentok_token')
    ...
    models = {
        ...
        'mci.completedtaskconcentrationcardposition': {
            'Meta': {'object_name': 'CompletedTaskConcentrationCardPosition'},
            'completed_task': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mci.CompletedTask']"}),
            'concentration_card': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mci.ConcentrationCard']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'mci.subject': {
            ...
            'opentok_token': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mci.Session']"}),
        ...
        'mci.taskconcentrationcardposition': {
            'Meta': {'object_name': 'TaskConcentrationCardPosition'},
            'concentration_card': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mci.ConcentrationCard']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mci.Task']"})
