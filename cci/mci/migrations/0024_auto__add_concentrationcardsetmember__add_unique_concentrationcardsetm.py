...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field cards on 'ConcentrationCardSet'
        db.delete_table('mci_concentrationcardset_cards')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field cards on 'ConcentrationCardSet'
        db.create_table('mci_concentrationcardset_cards', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('concentrationcardset', models.ForeignKey(orm['mci.concentrationcardset'], null=False)),
            ('concentrationcard', models.ForeignKey(orm['mci.concentrationcard'], null=False))
        ))
        db.create_unique('mci_concentrationcardset_cards', ['concentrationcardset_id', 'concentrationcard_id'])
