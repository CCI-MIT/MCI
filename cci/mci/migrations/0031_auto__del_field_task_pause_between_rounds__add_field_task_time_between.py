...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.pause_between_rounds'
        db.delete_column('mci_task', 'pause_between_rounds')

        # Adding field 'Task.time_between_rounds'
        db.add_column('mci_task', 'time_between_rounds',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.pause_between_rounds'
        db.add_column('mci_task', 'pause_between_rounds',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

        # Deleting field 'Task.time_between_rounds'
        db.delete_column('mci_task', 'time_between_rounds')
