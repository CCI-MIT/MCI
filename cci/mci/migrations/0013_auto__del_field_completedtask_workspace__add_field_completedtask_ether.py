...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompletedTask.workspace'
        db.delete_column('mci_completedtask', 'workspace')

        # Adding field 'CompletedTask.etherpad_workspace_url'
        db.add_column('mci_completedtask', 'etherpad_workspace_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'Task.interaction_workspace_source'
        db.delete_column('mci_task', 'interaction_workspace_source')

        # Adding field 'Task.etherpad_template'
        db.add_column('mci_task', 'etherpad_template',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'CompletedTask.workspace'
        db.add_column('mci_completedtask', 'workspace',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'CompletedTask.etherpad_workspace_url'
        db.delete_column('mci_completedtask', 'etherpad_workspace_url')

        # Adding field 'Task.interaction_workspace_source'
        db.add_column('mci_task', 'interaction_workspace_source',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Task.etherpad_template'
        db.delete_column('mci_task', 'etherpad_template')
    ...
    models = {
        ...
        'mci.concentrationcard': {
            ...
            'imageset': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'mci.etherpadlite': {
