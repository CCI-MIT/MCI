...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mci_eventlog', 'timestamp', self.gf('mci.models.DateTimeFractionField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EventLog.timestamp'
        db.alter_column(u'mci_eventlog', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'mci.si_sb_status': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 10, 0, 0)'}),
