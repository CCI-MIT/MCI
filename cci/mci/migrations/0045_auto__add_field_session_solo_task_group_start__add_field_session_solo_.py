...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.solo_task_group_start'
        db.add_column('mci_session', 'solo_task_group_start',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['mci.TaskGroup']),
                      keep_default=False)

        # Adding field 'Session.solo_task_group_end'
        db.add_column('mci_session', 'solo_task_group_end',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['mci.TaskGroup']),
                      keep_default=False)

        # Deleting field 'CompletedTask.solo'
        db.delete_column('mci_completedtask', 'solo')

        # Adding field 'CompletedTask.solo_subject'
        db.add_column('mci_completedtask', 'solo_subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['mci.Subject']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Session.solo_task_group_start'
        db.delete_column('mci_session', 'solo_task_group_start_id')

        # Deleting field 'Session.solo_task_group_end'
        db.delete_column('mci_session', 'solo_task_group_end_id')

        # Adding field 'CompletedTask.solo'
        db.add_column('mci_completedtask', 'solo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'CompletedTask.solo_subject'
        db.delete_column('mci_completedtask', 'solo_subject_id')
