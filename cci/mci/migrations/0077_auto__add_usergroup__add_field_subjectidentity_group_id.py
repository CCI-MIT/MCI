...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mci_usergroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('admin', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'mci', ['UserGroup'])

        # Adding M2M table for field users on 'UserGroup'
        db.create_table(u'mci_usergroup_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('usergroup', models.ForeignKey(orm[u'mci.usergroup'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'mci_usergroup_users', ['usergroup_id', 'user_id'])

        # Adding M2M table for field usergroups on 'TaskGroup'
        db.create_table(u'mci_taskgroup_usergroups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('taskgroup', models.ForeignKey(orm[u'mci.taskgroup'], null=False)),
            ('usergroup', models.ForeignKey(orm[u'mci.usergroup'], null=False))
        ))
        db.create_unique(u'mci_taskgroup_usergroups', ['taskgroup_id', 'usergroup_id'])

        # Adding M2M table for field usergroups on 'SessionTemplate'
        db.create_table(u'mci_sessiontemplate_usergroups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sessiontemplate', models.ForeignKey(orm[u'mci.sessiontemplate'], null=False)),
            ('usergroup', models.ForeignKey(orm[u'mci.usergroup'], null=False))
        ))
        db.create_unique(u'mci_sessiontemplate_usergroups', ['sessiontemplate_id', 'usergroup_id'])

        # Adding field 'SubjectIdentity.group_id'
        db.add_column(u'mci_subjectidentity', 'group_id',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field usergroups on 'Session'
        db.create_table(u'mci_session_usergroups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('session', models.ForeignKey(orm[u'mci.session'], null=False)),
            ('usergroup', models.ForeignKey(orm[u'mci.usergroup'], null=False))
        ))
        db.create_unique(u'mci_session_usergroups', ['session_id', 'usergroup_id'])

        # Adding M2M table for field usergroups on 'SessionBuilder'
        db.create_table(u'mci_sessionbuilder_usergroups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sessionbuilder', models.ForeignKey(orm[u'mci.sessionbuilder'], null=False)),
            ('usergroup', models.ForeignKey(orm[u'mci.usergroup'], null=False))
        ))
        db.create_unique(u'mci_sessionbuilder_usergroups', ['sessionbuilder_id', 'usergroup_id'])


    def backwards(self, orm):
        # Deleting model 'UserGroup'
        db.delete_table(u'mci_usergroup')

        # Removing M2M table for field users on 'UserGroup'
        db.delete_table('mci_usergroup_users')

        # Removing M2M table for field usergroups on 'TaskGroup'
        db.delete_table('mci_taskgroup_usergroups')

        # Removing M2M table for field usergroups on 'SessionTemplate'
        db.delete_table('mci_sessiontemplate_usergroups')

        # Deleting field 'SubjectIdentity.group_id'
        db.delete_column(u'mci_subjectidentity', 'group_id')

        # Removing M2M table for field usergroups on 'Session'
        db.delete_table('mci_session_usergroups')

        # Removing M2M table for field usergroups on 'SessionBuilder'
        db.delete_table('mci_sessionbuilder_usergroups')
    ...
    models = {
        ...
        u'mci.completedtask': {
            ...
            'scribe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mci.Subject']", 'null': 'True', 'blank': 'True'}),
        ...
        u'mci.si_sb_status': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 6, 0, 0)'}),
        ...
        u'mci.subjectidentity': {
            ...
            'group_id': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'mci.task': {
            ...
            'pct_tiles_on': ('django.db.models.fields.FloatField', [], {'default': '0.3'}),
            ...
            'scribe': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
