...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionTemplate.roster_time'
        db.add_column('mci_sessiontemplate', 'roster_time',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10),
                      keep_default=False)

        # Adding field 'Session.roster_time'
        db.add_column('mci_session', 'roster_time',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionTemplate.roster_time'
        db.delete_column('mci_sessiontemplate', 'roster_time')

        # Deleting field 'Session.roster_time'
        db.delete_column('mci_session', 'roster_time')
