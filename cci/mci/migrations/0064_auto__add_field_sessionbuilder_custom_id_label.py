...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionBuilder.custom_id_label'
        db.add_column('mci_sessionbuilder', 'custom_id_label',
                      self.gf('django.db.models.fields.CharField')(default='Username (e.g. Mturk ID)', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionBuilder.custom_id_label'
        db.delete_column('mci_sessionbuilder', 'custom_id_label')
