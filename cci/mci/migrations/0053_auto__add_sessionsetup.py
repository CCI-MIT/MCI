...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SessionSetup'
        db.create_table('mci_sessionsetup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.Session'], unique=True)),
        ))
        db.send_create_signal('mci', ['SessionSetup'])


    def backwards(self, orm):
        # Deleting model 'SessionSetup'
        db.delete_table('mci_sessionsetup')
