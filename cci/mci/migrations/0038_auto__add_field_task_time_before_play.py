...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.time_before_play'
        db.add_column('mci_task', 'time_before_play',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.time_before_play'
        db.delete_column('mci_task', 'time_before_play')
