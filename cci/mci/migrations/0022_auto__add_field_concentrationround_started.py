...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConcentrationRound.started'
        db.add_column('mci_concentrationround', 'started',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ConcentrationRound.started'
        db.delete_column('mci_concentrationround', 'started')
