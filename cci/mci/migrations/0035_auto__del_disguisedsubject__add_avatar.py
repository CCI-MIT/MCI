...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DisguisedSubject'
        db.delete_table('mci_disguisedsubject')

        # Adding model 'Avatar'
        db.create_table('mci_avatar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('viewed', self.gf('django.db.models.fields.related.ForeignKey')(related_name='disguised_subject', to=orm['mci.Subject'])),
            ('viewer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='disguise_target', to=orm['mci.Subject'])),
        ...
        db.send_create_signal('mci', ['Avatar'])


    def backwards(self, orm):
        # Adding model 'DisguisedSubject'
        db.create_table('mci_disguisedsubject', (
            ('display_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SubjectCountry'], null=True, blank=True)),
            ('disguised_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='disguised_subject', to=orm['mci.Subject'])),
            ('disguise_target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='disguise_target', to=orm['mci.Subject'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('mci', ['DisguisedSubject'])

        # Deleting model 'Avatar'
        db.delete_table('mci_avatar')
    ...
    models = {
        'mci.avatar': {
            ...
            'viewed': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'disguised_subject'", 'to': "orm['mci.Subject']"}),
            'viewer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'disguise_target'", 'to': "orm['mci.Subject']"})
        },
        'mci.completedtask': {
