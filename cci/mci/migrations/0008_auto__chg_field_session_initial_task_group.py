...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.initial_task_group'
        db.alter_column('mci_session', 'initial_task_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['mci.TaskGroup']))
    def backwards(self, orm):

        # Changing field 'Session.initial_task_group'
        db.alter_column('mci_session', 'initial_task_group_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mci.TaskGroup']))
    models = {
        'mci.completedtask': {
