...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionTemplate.roster_page'
        db.add_column('mci_sessiontemplate', 'roster_page',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Session.roster_page'
        db.add_column('mci_session', 'roster_page',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionTemplate.roster_page'
        db.delete_column('mci_sessiontemplate', 'roster_page')

        # Deleting field 'Session.roster_page'
        db.delete_column('mci_session', 'roster_page')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 14, 0, 0)'}),
