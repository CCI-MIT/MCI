...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubjectIdentity'
        db.create_table('mci_subjectidentity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True, null=True, blank=True)),
            ('mturk_id', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True, blank=True)),
            ('display_name', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SubjectCountry'], null=True, blank=True)),
            ('opentok_token', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
        ))
        db.send_create_signal('mci', ['SubjectIdentity'])

        # Adding model 'SessionCountryQuota'
        db.create_table('mci_sessioncountryquota', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sessionbuilder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SessionBuilder'])),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SubjectCountry'])),
            ('subjects', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('mci', ['SessionCountryQuota'])

        # Adding model 'SI_SB_Status'
        db.create_table('mci_si_sb_status', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sessionbuilder', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subject_identity_statuses', to=orm['mci.SessionBuilder'])),
            ('subject_identity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sessionbuilder_statuses', to=orm['mci.SubjectIdentity'])),
            ('arrival_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('dispatch_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('mci', ['SI_SB_Status'])

        # Adding model 'SessionBuilder'
        db.create_table('mci_sessionbuilder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('waiting_room_opens', self.gf('django.db.models.fields.DateTimeField')()),
            ('waiting_room_closes', self.gf('django.db.models.fields.DateTimeField')()),
            ('last_survey_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('previous_play_required', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('previous_play_forbidden', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('subjects_per_session', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=6)),
        ))
        db.send_create_signal('mci', ['SessionBuilder'])
        ...
        # Adding field 'Subject.subject_identity'
        db.add_column('mci_subject', 'subject_identity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SubjectIdentity'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting model 'SubjectIdentity'
        db.delete_table('mci_subjectidentity')

        # Deleting model 'SessionCountryQuota'
        db.delete_table('mci_sessioncountryquota')

        # Deleting model 'SI_SB_Status'
        db.delete_table('mci_si_sb_status')

        # Deleting model 'SessionBuilder'
        db.delete_table('mci_sessionbuilder')

        # Removing M2M table for field task_groups on 'SessionBuilder'
        db.delete_table('mci_sessionbuilder_task_groups')

        # Deleting field 'Subject.subject_identity'
        db.delete_column('mci_subject', 'subject_identity_id')
    ...
    models = {
        ...
        'mci.sessioncountryquota': {
            'Meta': {'object_name': 'SessionCountryQuota'},
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mci.SubjectCountry']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'mci.subject': {
            ...
            'subject_identity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mci.SubjectIdentity']", 'null': 'True', 'blank': 'True'})
        },
        'mci.subjectcountry': {
