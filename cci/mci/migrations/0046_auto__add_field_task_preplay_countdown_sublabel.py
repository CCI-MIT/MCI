...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.preplay_countdown_sublabel'
        db.add_column('mci_task', 'preplay_countdown_sublabel',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.preplay_countdown_sublabel'
        db.delete_column('mci_task', 'preplay_countdown_sublabel')
