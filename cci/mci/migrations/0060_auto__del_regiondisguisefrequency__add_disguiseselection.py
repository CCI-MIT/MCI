...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DisguiseSelection'
        db.create_table('mci_disguiseselection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session_template', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='disguise_selections', null=True, to=orm['mci.SessionTemplate'])),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='disguise_selections', null=True, to=orm['mci.Session'])),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(related_name='disguise_selections', to=orm['mci.Region'])),
            ('feminine', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('position', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal('mci', ['DisguiseSelection'])


    def backwards(self, orm):
        # Adding model 'RegionDisguiseFrequency'
        db.create_table('mci_regiondisguisefrequency', (
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='region_disguise_frequencies', null=True, to=orm['mci.Session'], blank=True)),
            ('frequency', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('session_template', self.gf('django.db.models.fields.related.ForeignKey')(related_name='region_disguise_frequencies', null=True, to=orm['mci.SessionTemplate'], blank=True)),
        ...
        # Deleting model 'DisguiseSelection'
        db.delete_table('mci_disguiseselection')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 0, 0)'}),
