...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subject.opentok_token'
        db.alter_column('mci_subject', 'opentok_token', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
    def backwards(self, orm):

        # Changing field 'Subject.opentok_token'
        db.alter_column('mci_subject', 'opentok_token', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    models = {
        'mci.completedtask': {
