...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SI_SB_Status.sb_group_id'
        db.add_column(u'mci_si_sb_status', 'sb_group_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SI_SB_Status.sb_group_id'
        db.delete_column(u'mci_si_sb_status', 'sb_group_id')
    ...
    models = {
        ...
        u'mci.si_sb_status': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 17, 0, 0)'}),
