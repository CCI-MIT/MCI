...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionTemplate.video_enabled'
        db.add_column('mci_sessiontemplate', 'video_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Session.video_enabled'
        db.add_column('mci_session', 'video_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionTemplate.video_enabled'
        db.delete_column('mci_sessiontemplate', 'video_enabled')

        # Deleting field 'Session.video_enabled'
        db.delete_column('mci_session', 'video_enabled')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 20, 0, 0)'}),
