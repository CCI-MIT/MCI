...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionBuilder.error_connecting_to_game_server_msg'
        db.add_column('mci_sessionbuilder', 'error_connecting_to_game_server_msg',
                      self.gf('django.db.models.fields.TextField')(default='Your browser is Javascript-enabled but for some reason\n        cannot connect to our real-time game server.  We have logged this and\n        will do our best to improve compatibility in the future.'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionBuilder.error_connecting_to_game_server_msg'
        db.delete_column('mci_sessionbuilder', 'error_connecting_to_game_server_msg')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
