...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subject.display_name'
        db.alter_column('mci_subject', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

    def backwards(self, orm):

        # Changing field 'Subject.display_name'
        db.alter_column('mci_subject', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
