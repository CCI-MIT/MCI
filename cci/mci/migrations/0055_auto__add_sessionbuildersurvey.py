...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SessionBuilderSurvey'
        db.create_table('mci_sessionbuildersurvey', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sessionbuilder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SessionBuilder'], unique=True)),
        ))
        db.send_create_signal('mci', ['SessionBuilderSurvey'])


    def backwards(self, orm):
        # Deleting model 'SessionBuilderSurvey'
        db.delete_table('mci_sessionbuildersurvey')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 4, 0, 0)'}),
