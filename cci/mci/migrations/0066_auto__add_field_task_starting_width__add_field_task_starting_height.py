...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.starting_width'
        db.add_column('mci_task', 'starting_width',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3),
                      keep_default=False)

        # Adding field 'Task.starting_height'
        db.add_column('mci_task', 'starting_height',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.starting_width'
        db.delete_column('mci_task', 'starting_width')

        # Deleting field 'Task.starting_height'
        db.delete_column('mci_task', 'starting_height')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 15, 0, 0)'}),
        ...
        'mci.task': {
            ...
            'starting_height': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '3'}),
