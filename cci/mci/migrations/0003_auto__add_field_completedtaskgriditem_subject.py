...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CompletedTaskGridItem.subject'
        db.add_column('mci_completedtaskgriditem', 'subject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.Subject'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CompletedTaskGridItem.subject'
        db.delete_column('mci_completedtaskgriditem', 'subject_id')
