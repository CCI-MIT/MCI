...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.pairs_in_generated_round'
        db.add_column('mci_task', 'pairs_in_generated_round',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.pairs_in_generated_round'
        db.delete_column('mci_task', 'pairs_in_generated_round')
