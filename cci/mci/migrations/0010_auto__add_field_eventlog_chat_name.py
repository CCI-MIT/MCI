...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventLog.chat_name'
        db.add_column('mci_eventlog', 'chat_name',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'EventLog.chat_name'
        db.delete_column('mci_eventlog', 'chat_name')
    ...
    models = {
        ...
        'mci.eventlog': {
            ...
            'chat_name': ('django.db.models.fields.TextField', [], {'null': 'True'}),
