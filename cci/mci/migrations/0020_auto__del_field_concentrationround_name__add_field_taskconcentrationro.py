...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConcentrationRound.name'
        db.delete_column('mci_concentrationround', 'name')

        # Adding field 'TaskConcentrationRoundTemplateIndex.name'
        db.add_column('mci_taskconcentrationroundtemplateindex', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'ConcentrationRound.name'
        db.add_column('mci_concentrationround', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TaskConcentrationRoundTemplateIndex.name'
        db.delete_column('mci_taskconcentrationroundtemplateindex', 'name')
