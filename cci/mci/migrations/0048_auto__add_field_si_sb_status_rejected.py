...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SI_SB_Status.rejected'
        db.add_column('mci_si_sb_status', 'rejected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SI_SB_Status.rejected'
        db.delete_column('mci_si_sb_status', 'rejected')
