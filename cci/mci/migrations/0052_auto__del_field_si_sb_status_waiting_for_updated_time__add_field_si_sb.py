...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SI_SB_Status.survey_tag'
        db.add_column('mci_si_sb_status', 'survey_tag',
    ...
    def backwards(self, orm):
        ...
        db.add_column('mci_si_sb_status', 'waiting_for_updated_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 11, 0, 0)),
                      keep_default=False)

        # Deleting field 'SI_SB_Status.survey_tag'
        db.delete_column('mci_si_sb_status', 'survey_tag')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 11, 0, 0)'}),
