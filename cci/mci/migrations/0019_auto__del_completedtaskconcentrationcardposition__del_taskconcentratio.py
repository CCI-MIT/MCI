...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CompletedTaskConcentrationCardPosition'
        db.delete_table('mci_completedtaskconcentrationcardposition')

        # Deleting model 'TaskConcentrationCardPosition'
        db.delete_table('mci_taskconcentrationcardposition')

        # Adding model 'TaskConcentrationRoundTemplateIndex'
        db.create_table('mci_taskconcentrationroundtemplateindex', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.Task'])),
            ('rnd_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.ConcentrationRoundTemplate'])),
            ('position', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal('mci', ['TaskConcentrationRoundTemplateIndex'])

        # Adding model 'ConcentrationRoundPosition'
        db.create_table('mci_concentrationroundposition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rnd', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.ConcentrationRound'])),
            ('card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.ConcentrationCard'])),
            ('position', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('mci', ['ConcentrationRoundPosition'])

        # Adding model 'ConcentrationRoundTemplate'
        db.create_table('mci_concentrationroundtemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('positions', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('card_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.ConcentrationCardSet'], null=True, blank=True)),
        ))
        db.send_create_signal('mci', ['ConcentrationRoundTemplate'])

        # Adding model 'ConcentrationRound'
        db.create_table('mci_concentrationround', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('completed_task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.CompletedTask'])),
            ('position', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal('mci', ['ConcentrationRound'])

        # Adding model 'ConcentrationCardSet'
        db.create_table('mci_concentrationcardset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('mci', ['ConcentrationCardSet'])

    def backwards(self, orm):
        # Adding model 'CompletedTaskConcentrationCardPosition'
        db.create_table('mci_completedtaskconcentrationcardposition', (
            ('position', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('completed_task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.CompletedTask'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concentration_card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.ConcentrationCard'])),
        ))
        db.send_create_signal('mci', ['CompletedTaskConcentrationCardPosition'])

        # Adding model 'TaskConcentrationCardPosition'
        db.create_table('mci_taskconcentrationcardposition', (
            ('position', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concentration_card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.ConcentrationCard'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.Task'])),
        ))
        db.send_create_signal('mci', ['TaskConcentrationCardPosition'])

        # Deleting model 'TaskConcentrationRoundTemplateIndex'
        db.delete_table('mci_taskconcentrationroundtemplateindex')

        # Deleting model 'ConcentrationRoundPosition'
        db.delete_table('mci_concentrationroundposition')

        # Deleting model 'ConcentrationRoundTemplate'
        db.delete_table('mci_concentrationroundtemplate')

        # Deleting model 'ConcentrationRound'
        db.delete_table('mci_concentrationround')

        # Deleting model 'ConcentrationCardSet'
        db.delete_table('mci_concentrationcardset')
