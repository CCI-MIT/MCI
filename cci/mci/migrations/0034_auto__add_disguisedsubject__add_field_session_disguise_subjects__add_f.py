...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'mci.disguisedsubject': {
            'Meta': {'object_name': 'DisguisedSubject'},
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mci.SubjectCountry']", 'null': 'True', 'blank': 'True'}),
            'disguise_target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'disguise_target'", 'to': "orm['mci.Subject']"}),
            'disguised_subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'disguised_subject'", 'to': "orm['mci.Subject']"}),
