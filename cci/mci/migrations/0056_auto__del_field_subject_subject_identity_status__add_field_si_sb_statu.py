...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SI_SB_Status.subject'
        db.add_column('mci_si_sb_status', 'subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.Subject'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SI_SB_Status.subject'
        db.delete_column('mci_si_sb_status', 'subject_id')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 5, 0, 0)'}),
