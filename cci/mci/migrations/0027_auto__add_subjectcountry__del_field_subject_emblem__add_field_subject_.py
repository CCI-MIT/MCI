...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubjectCountry'
        db.create_table('mci_subjectcountry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('flag', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('mci', ['SubjectCountry'])

        # Deleting field 'Subject.emblem'
        db.delete_column('mci_subject', 'emblem')

        # Adding field 'Subject.country'
        db.add_column('mci_subject', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SubjectCountry'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SubjectCountry'
        db.delete_table('mci_subjectcountry')

        # Adding field 'Subject.emblem'
        db.add_column('mci_subject', 'emblem',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Subject.country'
        db.delete_column('mci_subject', 'country_id')
    ...
    models = {
        ...
        'mci.subjectcountry': {
            'Meta': {'object_name': 'SubjectCountry'},
