...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.pct_tiles_on'
        db.add_column('mci_task', 'pct_tiles_on',
                      self.gf('django.db.models.fields.FloatField')(default=0.29999999999999999),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.pct_tiles_on'
        db.delete_column('mci_task', 'pct_tiles_on')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 19, 0, 0)'}),
