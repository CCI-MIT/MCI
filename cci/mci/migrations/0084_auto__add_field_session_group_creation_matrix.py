...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.group_creation_matrix'
        db.add_column(u'mci_session', 'group_creation_matrix',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.group_creation_matrix'
        db.delete_column(u'mci_session', 'group_creation_matrix')
    ...
    models = {
        ...
        u'mci.session': {
            ...
            'confirmation_deadline_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'group_creation_matrix': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'mci.si_sb_status': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 10, 0, 0)'}),
