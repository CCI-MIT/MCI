...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ConcentrationCardSetMember', fields ['card', 'card_set']
        db.delete_unique('mci_concentrationcardsetmember', ['card_id', 'card_set_id'])

        # Deleting model 'ConcentrationCardSetMember'
        db.delete_table('mci_concentrationcardsetmember')


        # Changing field 'Task.primer_time'
        db.alter_column('mci_task', 'primer_time', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):
        # Adding model 'ConcentrationCardSetMember'
        db.create_table('mci_concentrationcardsetmember', (
            ('card_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.ConcentrationCardSet'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.ConcentrationCard'])),
        ))
        db.send_create_signal('mci', ['ConcentrationCardSetMember'])

        # Adding unique constraint on 'ConcentrationCardSetMember', fields ['card', 'card_set']
        db.create_unique('mci_concentrationcardsetmember', ['card_id', 'card_set_id'])


        # Changing field 'Task.primer_time'
        db.alter_column('mci_task', 'primer_time', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        'mci.avatar': {
            ...
            'viewed': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'viewed'", 'to': "orm['mci.Subject']"}),
            'viewer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'viewer'", 'to': "orm['mci.Subject']"})
        },
        'mci.completedtask': {
        ...
        'mci.task': {
            ...
            'primer_time': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
