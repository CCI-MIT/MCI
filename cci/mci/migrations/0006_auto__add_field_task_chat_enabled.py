...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.chat_enabled'
        db.add_column('mci_task', 'chat_enabled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.chat_enabled'
        db.delete_column('mci_task', 'chat_enabled')
