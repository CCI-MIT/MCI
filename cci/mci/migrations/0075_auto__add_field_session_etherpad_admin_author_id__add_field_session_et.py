...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.etherpad_admin_author_id'
        db.add_column('mci_session', 'etherpad_admin_author_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Session.etherpad_admin_session_id'
        db.add_column('mci_session', 'etherpad_admin_session_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.etherpad_admin_author_id'
        db.delete_column('mci_session', 'etherpad_admin_author_id')

        # Deleting field 'Session.etherpad_admin_session_id'
        db.delete_column('mci_session', 'etherpad_admin_session_id')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)'}),
