...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subject.subject_identity_status'
        db.add_column('mci_subject', 'subject_identity_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SI_SB_Status'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Subject.subject_identity_status'
        db.delete_column('mci_subject', 'subject_identity_status_id')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 3, 0, 0)'}),
        ...
        'mci.subject': {
            ...
            'subject_identity_status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mci.SI_SB_Status']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'mci.subjectcountry': {
