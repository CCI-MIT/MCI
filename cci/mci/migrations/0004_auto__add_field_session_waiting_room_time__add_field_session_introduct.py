...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.waiting_room_time'
        db.add_column('mci_session', 'waiting_room_time', self.gf('django.db.models.fields.PositiveIntegerField')(default=900), keep_default=False)

        # Adding field 'Session.introduction_time'
        db.add_column('mci_session', 'introduction_time', self.gf('django.db.models.fields.PositiveIntegerField')(default=15), keep_default=False)

        # Adding field 'Session.done_time'
        db.add_column('mci_session', 'done_time', self.gf('django.db.models.fields.PositiveIntegerField')(default=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Session.waiting_room_time'
        db.delete_column('mci_session', 'waiting_room_time')

        # Deleting field 'Session.introduction_time'
        db.delete_column('mci_session', 'introduction_time')

        # Deleting field 'Session.done_time'
        db.delete_column('mci_session', 'done_time')
