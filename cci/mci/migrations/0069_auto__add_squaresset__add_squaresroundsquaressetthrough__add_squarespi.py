...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SquaresSet'
        db.create_table('mci_squaresset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('mci', ['SquaresSet'])

        # Adding model 'SquaresRoundSquaresSetThrough'
        db.create_table('mci_squaresroundsquaressetthrough', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('squares_round', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SquaresRound'])),
            ('squares_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SquaresSet'])),
            ('position', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('mci', ['SquaresRoundSquaresSetThrough'])

        # Adding model 'SquaresPiece'
        db.create_table('mci_squarespiece', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('squares_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SquaresSet'])),
            ('v0_x', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v0_y', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v1_x', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v1_y', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v2_x', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v2_y', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v3_x', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v3_y', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v4_x', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v4_y', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v5_x', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v5_y', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v6_x', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('v6_y', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('mci', ['SquaresPiece'])

        # Adding model 'SquaresRoundTemplateSquaresSetThrough'
        db.create_table('mci_squaresroundtemplatesquaressetthrough', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('squares_round_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SquaresRoundTemplate'])),
            ('squares_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.SquaresSet'])),
            ('position', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('mci', ['SquaresRoundTemplateSquaresSetThrough'])

        # Adding model 'SquaresRoundTemplate'
        db.create_table('mci_squaresroundtemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('mci', ['SquaresRoundTemplate'])

        # Adding model 'SquaresRound'
        db.create_table('mci_squaresround', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('mci', ['SquaresRound'])

        # Adding model 'TaskSquaresRoundTemplateIndex'
        db.create_table('mci_tasksquaresroundtemplateindex', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name='squares_round_template_indices', to=orm['mci.Task'])),
            ('rnd_template', self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_joints', to=orm['mci.SquaresRoundTemplate'])),
            ('position', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal('mci', ['TaskSquaresRoundTemplateIndex'])


    def backwards(self, orm):
        # Deleting model 'SquaresSet'
        db.delete_table('mci_squaresset')

        # Deleting model 'SquaresRoundSquaresSetThrough'
        db.delete_table('mci_squaresroundsquaressetthrough')

        # Deleting model 'SquaresPiece'
        db.delete_table('mci_squarespiece')

        # Deleting model 'SquaresRoundTemplateSquaresSetThrough'
        db.delete_table('mci_squaresroundtemplatesquaressetthrough')

        # Deleting model 'SquaresRoundTemplate'
        db.delete_table('mci_squaresroundtemplate')

        # Deleting model 'SquaresRound'
        db.delete_table('mci_squaresround')

        # Deleting model 'TaskSquaresRoundTemplateIndex'
        db.delete_table('mci_tasksquaresroundtemplateindex')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 16, 0, 0)'}),
