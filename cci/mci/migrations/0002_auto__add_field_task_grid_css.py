...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.grid_css'
        db.add_column('mci_task', 'grid_css', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.grid_css'
        db.delete_column('mci_task', 'grid_css')
