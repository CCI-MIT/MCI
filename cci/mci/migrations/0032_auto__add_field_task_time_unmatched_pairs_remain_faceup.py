...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.time_unmatched_pairs_remain_faceup'
        db.add_column('mci_task', 'time_unmatched_pairs_remain_faceup',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.time_unmatched_pairs_remain_faceup'
        db.delete_column('mci_task', 'time_unmatched_pairs_remain_faceup')
