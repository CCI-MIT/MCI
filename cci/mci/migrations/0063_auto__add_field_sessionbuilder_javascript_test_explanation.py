...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionBuilder.javascript_test_explanation'
        db.add_column('mci_sessionbuilder', 'javascript_test_explanation',
                      self.gf('django.db.models.fields.TextField')(default='Testing Javascript in your browser.  If this message does not\n\t\t\t  go away, Javascript is disabled or broken in your browser.  You must\n\t\t\t  have Javascript working in order to play.'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionBuilder.javascript_test_explanation'
        db.delete_column('mci_sessionbuilder', 'javascript_test_explanation')
    ...
    models = {
        ...
        'mci.sessionbuilder': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'javascript_test_explanation': ('django.db.models.fields.TextField', [], {'default': "'Testing Javascript in your browser.  If this message does not\\n\\t\\t\\t  go away, Javascript is disabled or broken in your browser.  You must\\n\\t\\t\\t  have Javascript working in order to play.'"}),
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 0, 0)'}),
