...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionBuilder.ask_for_group_id'
        db.add_column(u'mci_sessionbuilder', 'ask_for_group_id',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionBuilder.ask_for_group_id'
        db.delete_column(u'mci_sessionbuilder', 'ask_for_group_id')
