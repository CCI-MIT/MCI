...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.tiles_preview_seconds'
        db.add_column('mci_task', 'tiles_preview_seconds',
                      self.gf('django.db.models.fields.FloatField')(default=2.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.tiles_preview_seconds'
        db.delete_column('mci_task', 'tiles_preview_seconds')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 20, 0, 0)'}),
