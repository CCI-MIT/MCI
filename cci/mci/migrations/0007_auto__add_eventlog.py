...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mci_eventlog', (
            ...
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.Subject'], null=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.Session'], null=True)),
            ('session_group', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('completed_task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mci.CompletedTask'], null=True)),
            ('ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('mci', ['EventLog'])


    def backwards(self, orm):
        
        # Deleting model 'EventLog'
        db.delete_table('mci_eventlog')
