...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Session.mousemove_interval'
        db.delete_column('mci_session', 'mousemove_interval')

        # Adding field 'Task.mousemove_interval'
        db.add_column('mci_task', 'mousemove_interval',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Session.mousemove_interval'
        db.add_column('mci_session', 'mousemove_interval',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=100),
                      keep_default=False)

        # Deleting field 'Task.mousemove_interval'
        db.delete_column('mci_task', 'mousemove_interval')
