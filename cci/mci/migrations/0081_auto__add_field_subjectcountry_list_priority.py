...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectCountry.list_priority'
        db.add_column(u'mci_subjectcountry', 'list_priority',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectCountry.list_priority'
        db.delete_column(u'mci_subjectcountry', 'list_priority')
    ...
    models = {
        ...
        u'mci.si_sb_status': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 27, 0, 0)'}),
