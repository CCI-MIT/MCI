...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.primer_sidebar_text'
        db.add_column('mci_task', 'primer_sidebar_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.primer_sidebar_text'
        db.delete_column('mci_task', 'primer_sidebar_text')
