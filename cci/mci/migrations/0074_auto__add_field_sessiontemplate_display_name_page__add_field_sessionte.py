...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionTemplate.display_name_page'
        db.add_column('mci_sessiontemplate', 'display_name_page',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SessionTemplate.display_name_time'
        db.add_column('mci_sessiontemplate', 'display_name_time',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=15),
                      keep_default=False)

        # Adding field 'Session.display_name_page'
        db.add_column('mci_session', 'display_name_page',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Session.display_name_time'
        db.add_column('mci_session', 'display_name_time',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SessionTemplate.display_name_page'
        db.delete_column('mci_sessiontemplate', 'display_name_page')

        # Deleting field 'SessionTemplate.display_name_time'
        db.delete_column('mci_sessiontemplate', 'display_name_time')

        # Deleting field 'Session.display_name_page'
        db.delete_column('mci_session', 'display_name_page')

        # Deleting field 'Session.display_name_time'
        db.delete_column('mci_session', 'display_name_time')
    ...
    models = {
        ...
        'mci.si_sb_status': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 28, 0, 0)'}),
