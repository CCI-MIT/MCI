...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.confirmation_deadline_datetime'
        db.add_column(u'mci_session', 'confirmation_deadline_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.confirmation_deadline_datetime'
        db.delete_column(u'mci_session', 'confirmation_deadline_datetime')
    ...
    models = {
        ...
        u'mci.si_sb_status': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_waiting_room_checkin': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 11, 0, 0)'}),
