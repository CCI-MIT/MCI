...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mci_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('owns_all_owned_objects', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'mci', ['UserProfile'])

        # Deleting field 'UserGroup.admin'
        db.delete_column(u'mci_usergroup', 'admin')


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'mci_userprofile')

        # Adding field 'UserGroup.admin'
        db.add_column(u'mci_usergroup', 'admin',
